...
module.exports = {
  ...
  body: p => `
    (module power_switch_spdt (layer F.Cu) (tstamp 0)
      ...
      ${'' /* switch body ~8 x 3.5mm; the actuator (+y) side overhangs the PCB
            edge, so its silk is pulled in to 1.4 to clear Edge.Cuts. */}
      (fp_line (start -4.0 -1.4) (end 4.0 -1.4) (layer ${p.side}.SilkS) (width 0.12))
      (fp_line (start -4.0 1.4) (end 4.0 1.4) (layer ${p.side}.SilkS) (width 0.12))
      (fp_line (start -4.0 -1.4) (end -4.0 1.4) (layer ${p.side}.SilkS) (width 0.12))
      (fp_line (start 4.0 -1.4) (end 4.0 1.4) (layer ${p.side}.SilkS) (width 0.12))
